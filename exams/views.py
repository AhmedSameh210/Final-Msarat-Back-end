...
# Determine pass/fail logic based on learning phase
    ...
    # Determine pass/fail logic based on learning phase
        ...
        beginner_score = beginner_correct_count * 1
        intermediate_score = intermediate_correct_count * 3
        advanced_score = advanced_correct_count * 5
        total_weighted_score = beginner_score + intermediate_score + advanced_score
        total_possible_score = (beginner_total_count * 1) + (intermediate_total_count * 3) + (advanced_total_count * 5)
        score_percentage = (total_weighted_score / total_possible_score) * 100 if total_possible_score > 0 else 0
